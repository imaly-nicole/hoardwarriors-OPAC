...
<head>
    ...
    <div class="main">
        ...
        <div class="content">
            <h1>Online Public Access Catalog</span> <br>Hoard Warriors</h1>
            <p class="par">Welcome to Hoard Warrior's OPAC <br> We aim to provide you with services
                <br> and help you find books that you like.</p>
